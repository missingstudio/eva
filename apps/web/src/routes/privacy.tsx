...
/*
  ...
  cookie is written by packages/brand/src/theme.ts, the two typefaces are files
  in packages/brand/fonts, and there is no analytics call anywhere in either
...
function Privacy() {
  return (
    <Page className="max-w-page mx-auto px-6 pt-24 pb-20">
      ...
      <p className="text-muted max-w-measure mt-4">
      ...
      <ul className="text-muted max-w-measure mt-4 space-y-2">
