...
| Page     | proven  | `apps/web/src/shell.test.tsx` › "says the pipe is down while it is down" · `apps/web/src/composer.test.tsx` › "refuses the send visibly rather than taking the line" · `packages/conformance/src/page-converges.test.ts` › "converges from the Cursor it holds when the pipe drops mid-Run"                                  | —                                                                                                                                                                                                                                                               |
